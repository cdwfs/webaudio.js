window.AudioContext=window.AudioContext||window.webkitAudioContext;WebAudio=function(){if(!1===WebAudio.isAvailable)throw this._addRequiredMessage(),Error("WebAudio API is required and not available.");this._ctx=new AudioContext;this._muted=!1;this._volume=1;this._gainNode=this._ctx.createGain();this._compressor=this._ctx.createDynamicsCompressor();this._gainNode.connect(this._compressor);this._compressor.connect(this._ctx.destination);this._pageVisibilityCtor()};WebAudio.fn=WebAudio.prototype;
WebAudio.prototype.destroy=function(){this._pageVisibilityDtor()};WebAudio.isAvailable=window.AudioContext?!0:!1;
WebAudio.prototype._addRequiredMessage=function(a){a=a||document.body;var b=document.createElement("div");b.style.fontFamily="monospace";b.style.fontSize="13px";b.style.textAlign="center";b.style.background="#eee";b.style.color="#000";b.style.padding="1em";b.style.width="475px";b.style.margin="5em auto 0";b.innerHTML='Your browser does not seem to support <a href="https://dvcs.w3.org/hg/audio/raw-file/tip/webaudio/specification.html">WebAudio API</a>.<br />\nTry with <a href="https://www.google.com/intl/en/chrome/browser/">Chrome Browser</a>.';a.appendChild(b)};
...
WebAudio.prototype.toggleMute=function(){this.mute()?this.mute(!1):this.mute(!0)};
...
WebAudio.Sound.prototype.amplitude=function(a){a=void 0!==a?a:2;var b=this._analyser,c=new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);for(var d=b=0;d<a;d++)b+=c[d];return b/(256*a-1)};WebAudio.Sound.prototype.tone=function(a,b){a=void 0!==a?a:200;b=void 0!==b?b:1;for(var c=this._webaudio.context().createBuffer(1,44100*b,44100),d=c.getChannelData(0),e=0;e<d.length;e++)d[e]=2*Math.sin(a*(e/c.sampleRate)*Math.PI);this.buffer(c);return this};
WebAudio.Sound.prototype.makeHistogram=function(a){var b=this._analyser,c=this._privHisto=this._privHisto||new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);a=Math.floor(c.length/a);for(var b=[],d=0,e=0;d<c.length;e++){for(var f=0,g=0;g<a;g++,d++)f+=c[d];b[e]=f/a}return b};
WebAudio.Sound.prototype.load=function(a,b,c){c=c||function(){console.warn("unable to load sound "+a)};this._loadAndDecodeSound(a,function(a){this._source.buffer=a;b&&b(this)}.bind(this),function(){c&&c(this)}.bind(this));return this};WebAudio.Sound.prototype._loadAndDecodeSound=function(a,b,c){var d=this._context,e=new XMLHttpRequest;e.open("GET",a,!0);e.responseType="arraybuffer";e.onload=function(){d.decodeAudioData(e.response,function(a){b&&b(a)},function(){c&&c()})};e.send()};
WebAudio.Flow=function(){var a,b=[],c=setTimeout(function(){c=null;a._next()},0);return a={destroy:function(){c&&clearTimeout(c)},par:function(c,e){!e&&b[b.length-1]instanceof Array||b.push([]);b[b.length-1].push(c);return a},seq:function(b){return a.par(b,!0)},_next:function(c,e){for(var f=[],g=[],k=b.shift()||[],l=k.length,m=1==l,h=0;h<k.length;h++)(function(b,h){b(function(b,c){f[h]=b;g[h]=c;0==--l&&a._next(m?f[0]:f,m?g[0]:g)},c,e)})(k[h],h)}}};
...
WebAudio.Sound.fn.updateWithMatrix4=function(a,b){console.assert(a instanceof THREE.Matrix4);console.assert("number"===typeof b);var c=(new THREE.Vector3).getPositionFromMatrix(a);this._panner.setPosition(c.x,c.y,c.z);var c=new THREE.Vector3(0,0,1),d=a.clone();d.setPosition({x:0,y:0,z:0});c.applyMatrix4(d);c.normalize();this._panner.setOrientation(c.x,c.y,c.z);void 0===this._prevPos?this._prevPos=(new THREE.Vector3).getPositionFromMatrix(a):(c=(new THREE.Vector3).getPositionFromMatrix(a),d=c.clone().sub(this._prevPos).divideScalar(b),
this._prevPos=c.clone(),this._panner.setVelocity(d.x,d.y,d.z))};WebAudio.Sound.fn.follow=function(a,b){b=b||tQuery.world;console.assert(!1===this.isFollowing());a instanceof tQuery.Object3D&&(console.assert(1===a.length),a=a.get(0));console.assert(a instanceof THREE.Object3D);this._followCb=function(b){this.updateWithObject3d(a,b)}.bind(this);b.loop().hook(this._followCb);return this};WebAudio.Sound.fn.unfollow=function(a){this._world.loop().unhook(this._followCb);this._followCb=null;return this};
...
WebAudio.fn._followListenerCb=function(a,b){var c=this._ctx;console.assert(a instanceof THREE.Object3D);console.assert("number"===typeof b);a.updateMatrixWorld();var d=a.matrixWorld,e=(new THREE.Vector3).getPositionFromMatrix(d);c.listener.setPosition(e.x,e.y,e.z);e=d.clone();e.setPosition({x:0,y:0,z:0});var f=new THREE.Vector3(0,0,1);f.applyMatrix4(e);f.normalize();var g=new THREE.Vector3(0,-1,0);g.applyMatrix4(e);g.normalize();c.listener.setOrientation(f.x,f.y,f.z,g.x,g.y,g.z);void 0===this._prevPos?
this._prevPos=(new THREE.Vector3).getPositionFromMatrix(d):(e=(new THREE.Vector3).getPositionFromMatrix(d),d=e.clone().sub(this._prevPos).divideScalar(b),this._prevPos=e.clone(),c.listener.setVelocity(d.x,d.y,d.z))};
