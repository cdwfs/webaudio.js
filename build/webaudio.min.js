...
WebAudio.Sound.prototype.amplitude=function(a){a=void 0!==a?a:2;var b=this._analyser,c=new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);for(var e=b=0;e<a;e++)b+=c[e];return b/(256*a-1)};WebAudio.Sound.prototype.tone=function(a,b){a=void 0!==a?a:200;b=void 0!==b?b:1;for(var c=this._webaudio.context().createBuffer(1,44100*b,44100),e=c.getChannelData(0),d=0;d<e.length;d++)e[d]=2*Math.sin(a*(d/c.sampleRate)*Math.PI);this.buffer(c);return this};
WebAudio.Sound.prototype.makeHistogram=function(a){var b=this._analyser,c=this._privHisto=this._privHisto||new Uint8Array(b.frequencyBinCount);b.getByteFrequencyData(c);a=Math.floor(c.length/a);for(var b=[],e=0,d=0;e<c.length;d++){for(var f=0,h=0;h<a;h++,e++)f+=c[e];b[d]=f/a}return b};
WebAudio.Sound.prototype.load=function(a,b,c){c=c||function(){console.warn("unable to load sound "+a)};this._loadAndDecodeSound(a,function(a){this._source.buffer=a;b&&b(this)}.bind(this),function(){c&&c(this)}.bind(this));return this};WebAudio.Sound.prototype._loadAndDecodeSound=function(a,b,c){var e=this._context,d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){e.decodeAudioData(d.response,function(a){b&&b(a)},function(){c&&c()})};d.send()};
WebAudio.Flow=function(){var a,b=[],c=setTimeout(function(){c=null;a._next()},0);return a={destroy:function(){c&&clearTimeout(c)},par:function(c,d){!d&&b[b.length-1]instanceof Array||b.push([]);b[b.length-1].push(c);return a},seq:function(b){return a.par(b,!0)},_next:function(c,d){for(var f=[],h=[],k=b.shift()||[],l=k.length,m=1==l,g=0;g<k.length;g++)(function(b,g){b(function(b,c){f[g]=b;h[g]=c;0==--l&&a._next(m?f[0]:f,m?h[0]:h)},c,d)})(k[g],g)}}};
